...
//		 registerPage.clickregisterWithoutPassword(userName);
	...
	//User verifies for the mismatch error message
	@Then("User verifies for the mismatch error msg {string}")
	public void user_verifies_for_the_mismatch_error_msg(String mmerror) {
		System.out.println("mismatcherror print"+mmerror);
		System.out.println("Error msg is "+error);
	   Assert.assertEquals(error,mmerror);
