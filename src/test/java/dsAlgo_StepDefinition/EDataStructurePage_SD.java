...
public class EDataStructurePage_SD {
	...
	private static final Logger logger = LogManager.getLogger(EDataStructurePage_SD.class);
	...
	public void user_click_on_time_complexity() {
		logger.info("going to click in time complexity link");
	...
	public void user_enter_the_python_code(io.cucumber.datatable.DataTable pythonCode) throws InterruptedException {
			//pythonCode is object of DataTable written in feature file
	//	 List<List<String>>data=pythonCode.cells();//cels() teruring cell of a table
